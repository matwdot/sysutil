...
echo -e "\n${BOLD}${YELLOW}🚀 Para iniciar o SysUtil:${NC}"
echo -e "  ${GREEN}sysutil${NC}                    ${DIM}(de qualquer lugar)${NC}"
echo -e "  ${WHITE}cd ~/sysutil && ./sysutil.sh${NC}  ${DIM}(execução direta)${NC}"

echo -e "\n${BOLD}${GREEN}✨ Pronto para usar! ✨${NC}"